...
export function PathGrid() {
  const path = featuredPaths[0];

  return (
    <section className="section-shell py-24 sm:py-32">
      <Container>
        <SectionHeading
          eyebrow="Percorso evolutivo"
          title="Trasformare intuizioni e simboli in direzione concreta"
          description="Quando hai bisogno di leggere il presente con più lucidità e trasformare ciò che senti in una scelta più chiara, puoi partire da qui."
        />
