...
export default function TarocchiPage() {
  return (
    <main>
            ...
            <SurfaceCard className="relative overflow-hidden p-8 sm:p-10">
              ...
              <div className="relative z-10 mt-6 flex items-center justify-center rounded-[28px] border border-gold/15 bg-white/[0.03] p-6">
                <Image
                  ...
                  alt="Il Matto come immagine simbolica della pagina Tarocchi"
                  width={958}
                  height={1425}
      ...
      <GenericFinalCta
        title="I Tarocchi non ti dicono chi diventare. Ti aiutano a vedere chi sta già emergendo."
        body="Se stai attraversando un nodo, una scelta o un momento di passaggio, possiamo leggerlo insieme."
